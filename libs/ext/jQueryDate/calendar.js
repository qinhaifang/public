...
(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            '<div class="calendar-inner" style="width: 100%!important;">',
            '<div class="calendar-views">',
            '<div class="view view-date" style="width: 100%!important;">',
            '<div class="calendar-hd">',
            '<div class="calendar-arrow" style="float:left;margin: 0;">',
            '<span class="prev" title="上一月" data-calendar-arrow-date>{prev}</span>',
            '</div>',
            '<a href="javascript:;" data-calendar-display-date class="calendar-display" style="width: calc(100% - 100px);text-align: center;">',
            '{yyyy}/<span class="m">{mm}</span>',
            '</a>',
            '<div class="calendar-arrow" style="float:right;margin: 0;">',
            // '<span class="prev" title="上一月" data-calendar-arrow-date>{prev}</span>',
            '<span class="next" title="下一月" data-calendar-arrow-date>{next}</span>',
            '</div>',
            '</div>',
            '<div class="calendar-ct" style="width: 100%!important;">',
            '<ol class="week">{week}</ol>',
            '<ul class="date-items"></ul>',
            '</div>',
            '</div>',
            '<div class="view view-month" style="width: 100%!important;">',
            '<div class="calendar-hd" style="width: 100%!important;">',
            '<div class="calendar-arrow" style="float:left;margin: 0;">',
            ...
            '</div>',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display" style="width: calc(100% - 100px);text-align: center;">{yyyy}</a>',
            '<div class="calendar-arrow" style="float:left;margin: 0;width: 25px;">',
            // '<span class="prev" title="上一年" data-calendar-arrow-month>{prev}</span>',
            '<span class="next" title="下一年" data-calendar-arrow-month>{next}</span>',
            '</div>',
            '</div>',
            '<ol class="calendar-ct month-items" style="width: 100%!important;">{month}</ol>',
            '</div>',
            '</div>',
            '</div>',
